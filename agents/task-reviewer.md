...
**Output persistence:** Your structured review output will be stored as the `review_report` field on the Stride task record when the agent calls the completion API.
...
- Be constructive and proportional
